...
public class ResponseStrings {
    ...
    public static final String UndefUser="Register";

    public static final String ErrorWhileRegister = "Error while register";
    public static final String BuyError = "Register firstly";
